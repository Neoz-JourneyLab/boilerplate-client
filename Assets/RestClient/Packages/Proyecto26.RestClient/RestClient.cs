...
namespace Proyecto26 {
  ...
  public static partial class RestClient {
    ...
    /// </summary>
    public static Version Version => typeof(RestClient).Assembly.GetName().Version;

    /// <summary>
    ///   Default query string params.
    /// </summary>
    static Dictionary<string, string> _defaultRequestParams;
    public static Dictionary<string, string> DefaultRequestParams {
      get {
        if (_defaultRequestParams == null) _defaultRequestParams = new Dictionary<string, string>();
    ...
    /// </summary>
    public static void ClearDefaultParams() => DefaultRequestParams.Clear();

    /// <summary>
    ///   Default headers.
    /// </summary>
    static Dictionary<string, string> _defaultRequestHeaders;
    public static Dictionary<string, string> DefaultRequestHeaders {
      get {
        if (_defaultRequestHeaders == null) _defaultRequestHeaders = new Dictionary<string, string>();
    ...
    /// </summary>
    public static void ClearDefaultHeaders() => DefaultRequestHeaders.Clear();
    ...
    /// <param name="callback">A callback function that is executed when the request is finished.</param>
    public static void Get(string url, Action<RequestException, ResponseHelper> callback) => Get(new RequestHelper { Uri = url }, callback);
    ...
    /// <param name="callback">A callback function that is executed when the request is finished.</param>
    /// <typeparam name="T">The element type of the response.</typeparam>
    public static void Get<T>(string url, Action<RequestException, ResponseHelper, T> callback) => Get(new RequestHelper { Uri = url }, callback);
    ...
    public static void GetArray<T>(string url, Action<RequestException, ResponseHelper, T[]> callback) => GetArray(new RequestHelper { Uri = url }, callback);
    ...
    /// <param name="callback">A callback function that is executed when the request is finished.</param>
    public static void Post(string url, object body, Action<RequestException, ResponseHelper> callback) => Post(new RequestHelper { Uri = url, Body = body }, callback);
    ...
    PostArray(new RequestHelper { Uri = url, Body = body }, callback);
    ...
    PostArray(new RequestHelper { Uri = url, BodyString = bodyString }, callback);
    ...
    /// <param name="body">A plain object that is sent to the server with the request.</param>
    /// <param name="callback">A callback function that is executed when the request is finished.</param>
    public static void Put(string url, object body, Action<RequestException, ResponseHelper> callback) => Put(new RequestHelper { Uri = url, Body = body }, callback);
    ...
    /// <param name="url">A string containing the URL to which the request is sent.</param>
    /// <param name="callback">A callback function that is executed when the request is finished.</param>
    public static void Delete(string url, Action<RequestException, ResponseHelper> callback) => Delete(new RequestHelper { Uri = url }, callback);
    ...
    /// <param name="url">A string containing the URL to which the request is sent.</param>
    /// <param name="callback">A callback function that is executed when the request is finished.</param>
    public static void Head(string url, Action<RequestException, ResponseHelper> callback) => Head(new RequestHelper { Uri = url }, callback);
