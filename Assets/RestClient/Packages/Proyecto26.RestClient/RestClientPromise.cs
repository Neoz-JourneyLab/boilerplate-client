...
namespace Proyecto26 {
	public static partial class RestClient {
		...
		public static IPromise<ResponseHelper> Get(string url) => Get(new RequestHelper { Uri = url });
		...
		/// <param name="url">A string containing the URL to which the request is sent.</param>
		/// <typeparam name="T">The element type of the response.</typeparam>
		public static IPromise<T> Get<T>(string url) => Get<T>(new RequestHelper { Uri = url });
		...
		public static IPromise<T[]> GetArray<T>(string url) => GetArray<T>(new RequestHelper { Uri = url });
		...
		public static IPromise<ResponseHelper> Post(string url, object body) => Post(new RequestHelper { Uri = url, Body = body });
		...
		public static IPromise<ResponseHelper> Post(string url, string bodyString) => Post(new RequestHelper { Uri = url, BodyString = bodyString });
		...
		internal static object Post<T>(object currentRequest) => throw new NotImplementedException();
		...
		/// <param name="body">A plain object that is sent to the server with the request.</param>
		/// <typeparam name="T">The element type of the response.</typeparam>
		public static IPromise<T> Post<T>(string url, object body) => Post<T>(new RequestHelper { Uri = url, Body = body });
		...
		/// <param name="bodyString">A string that is sent to the server with the request.</param>
		/// <typeparam name="T">The element type of the response.</typeparam>
		public static IPromise<T> Post<T>(string url, string bodyString) => Post<T>(new RequestHelper { Uri = url, BodyString = bodyString });
		...
		/// <param name="body">A plain object that is sent to the server with the request.</param>
		/// <typeparam name="T">The element type of the array.</typeparam>
		public static IPromise<T[]> PostArray<T>(string url, object body) => PostArray<T>(new RequestHelper { Uri = url, Body = body });
		...
		/// <param name="bodyString">A string that is sent to the server with the request.</param>
		/// <typeparam name="T">The element type of the array.</typeparam>
		public static IPromise<T[]> PostArray<T>(string url, string bodyString) => PostArray<T>(new RequestHelper { Uri = url, BodyString = bodyString });
		...
		/// <param name="url">A string containing the URL to which the request is sent.</param>
		/// <param name="body">A plain object that is sent to the server with the request.</param>
		public static IPromise<ResponseHelper> Put(string url, object body) => Put(new RequestHelper { Uri = url, Body = body });
		...
		/// <param name="url">A string containing the URL to which the request is sent.</param>
		/// <param name="bodyString">A string that is sent to the server with the request.</param>
		public static IPromise<ResponseHelper> Put(string url, string bodyString) => Put(new RequestHelper { Uri = url, BodyString = bodyString });
		...
		/// <param name="body">A plain object that is sent to the server with the request.</param>
		/// <typeparam name="T">The element type of the response.</typeparam>
		public static IPromise<T> Put<T>(string url, object body) => Put<T>(new RequestHelper { Uri = url, Body = body });
		...
		/// <param name="bodyString">A string that is sent to the server with the request.</param>
		/// <typeparam name="T">The element type of the response.</typeparam>
		public static IPromise<T> Put<T>(string url, string bodyString) => Put<T>(new RequestHelper { Uri = url, BodyString = bodyString });
		...
		/// <returns>Returns a promise for a value of type ResponseHelper.</returns>
		/// <param name="url">A string containing the URL to which the request is sent.</param>
		public static IPromise<ResponseHelper> Delete(string url) => Delete(new RequestHelper { Uri = url });
		...
		/// <returns>Returns a promise for a value of type ResponseHelper.</returns>
		/// <param name="url">A string containing the URL to which the request is sent.</param>
		public static IPromise<ResponseHelper> Head(string url) => Delete(new RequestHelper { Uri = url });
		...
		/// <typeparam name="T">The element type of the response.</typeparam>
		static void Promisify<T>(this Promise<T> promise, RequestException error, T response) {
		...
		/// <typeparam name="T">The element type of the response.</typeparam>
		static void Promisify<T>(this Promise<T> promise, RequestException error, ResponseHelper response, T body) {
			if (error != null && response != null) error.ServerMessage = response.Error ?? error.Message;
