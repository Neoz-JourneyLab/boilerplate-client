 ...
 */
	...
	public void AddField(string str) {
		AddField(CreateStringObject(str));
	}
	public void AddField(AddJSONConents content) {
		AddField(Create(content));
	}
	public void AddField(JSONObject obj) {
